...
public class FlightPage extends Utility {
    ...
    public static void enterFlyingFrom(String flyingLocation) {
        sendTextToElement(flyingFrom, flyingLocation);
    }

    public static void enterGoingTo(String goingLocation) {
        sendTextToElement(goingTo, goingLocation);
    }

    public static void enterDepartingDate(String date) {
        sendTextToElement(departing, date);
    }

    public static void enterReturningDate(String returnDate) {
        clearTextFromField(returning);
        sendTextToElement(returning, returnDate);
    }

    private void clearTextFromField(By returning) {
    }

    public static void clickOnTravellers() {
